...
class Auth extends CI_Controller
{
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($user['role_id'] == 2) {
                        ...
                        if ($user['status_bayar'] == NULL) {
                            if ($user['jalur_pendaftaran'] == 'Reguler') {
                            ...
                            } elseif ($user['jalur_pendaftaran'] == 'Prestasi') {
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('jalur_pendaftaran', 'Jalur Pendaftaran', 'required|trim');
