                ...
                <div class="card-body">
                    ...
                    <div class="row text-center mb-5 border-white border-2" id="judul">
                        ...
                        <div class="col-md-3 bg-success btn" id="judul1">
                            <h6 class="card-subtitle text-white btn btn-lg col-lg">BIODATA <i data-feather="check"></i>
                            </h6>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="col-md-3 bg-success btn">
                            <h6 class="card-subtitle text-white btn btn-lg col-lg">SEKOLAH ASAL <i
                                    data-feather="check"></i></h6>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="col-md-3 bg-success btn">
                            <h6 class="card-subtitle text-white btn btn-lg col-lg">PRESTASI <i data-feather="check"></i>
                            </h6>
                        </div>
                        <?php else : ?>
                        <div class="col-md-3 bg-danger btn">
                        ...
                        <div class="col-md-3 bg-success btn">
                            <h6 class="card-subtitle text-white btn btn-lg col-lg">DATA ORANG TUA <i
                                    data-feather="check"></i></h6>
                        </div>
                        <?php else : ?>
                        <div class="col-md-3 bg-danger btn">
                    ...
                    <div class="" id="biodata">
                        ...
                        <div class="visually-hidden" id="biodata">
                            <?php endif; ?>
                            <form action="<?= base_url('user/aksi_tambah_formulir') ?>" method="POST"
                                ...
                                <div class="mb-3">
                                    <label for="jalur_seleksi" class="form-label">Prodi Pilihan 2 <span
                                            class="text-danger" style="font-size: 20px;">*</span></label>
                                    <select class="form-select" id="prodi2" name="prodi2" required>
                                        <option value="" selected disabled>Pilih Prodi</option>
                                        <?php foreach ($prodi as $p) : ?>
                                        <option value="<?= $p['id'] ?>"><?= $p['nama_prodi'] ?></option>
                                        <?php endforeach; ?>
                                ...
                                <div class="mb-3">
                                    <label for="ttl" class="form-label">Tempat, Tanggal Lahir <span class="text-danger"
                                            style="font-size: 20px;">*</span></label>
                                    <div class="row">
                                        <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    <label for="provinsi_tempat_lahir" class="form-label">Provinsi Tempat Lahir <span
                                            class="text-danger" style="font-size: 20px;">*</span></label>
                                    <select class="form-select" id="provinsi_tempat_lahir" name="provinsi_tempat_lahir"
                                        required>
                                        <option value="" selected disabled>Pilih Provinsi</option>
                                        <?php foreach ($provinsi as $prov_lahir) : ?>
                                        <option value="<?= $prov_lahir['nama_provinsi'] ?>">
                                            <?= $prov_lahir['nama_provinsi'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="nik" class="form-label">NIK <span class="text-danger"
                                            style="font-size: 20px;">*</span></label>
                                    <input type="text" class="form-control" id="nik" name="nik"
                                        value="<?= $user['nik']; ?>" readonly required>
                                </div>
                                <div class="mb-3">
                                    <label for="nisn" class="form-label">NISN <span class="text-danger"
                                            style="font-size: 20px;">*</span></label>
                                    <input type="text" class="form-control" id="nisn" name="nisn" required>
                                    <small>*Jika tidak punya NISN silahkan isi 0 (NOL)</small>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="no_hp" class="form-label">No Hp / Whatsapp <span class="text-danger"
                                            style="font-size: 20px;">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="alamat_lengkap" class="form-label">Alamat Lengkap <span
                                            class="text-danger" style="font-size: 20px;">*</span></label>
                                    <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap" cols="30"
                                        rows="10" required></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="provinsi_tempat_tinggal" class="form-label">Provinsi Tempat Tinggal
                                ...
                                <div class="mb-3">
                                    <label for="kabupaten_tempat_tinggal" class="form-label">Kabupaten Tempat Tinggal
                                        <span class="text-danger" style="font-size: 20px;">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="kecamatan_tempat_tinggal" class="form-label">Kecamatan Tempat Tinggal
                                        <span class="text-danger" style="font-size: 20px;">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="kode_pos" class="form-label">Kode Pos Tempat Tinggal <span
                                            class="text-danger" style="font-size: 20px;">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Upload pas foto <span class="text-danger"
                                            style="font-size: 20px;">*</span></label>
                        ...
                        <div class="" id="data_sekolah">
                            ...
                            <div class="visually-hidden" id="data_sekolah">
                                ...
                                <form action="<?= base_url('user/aksi_tambah_sekolah_asal'); ?>" method="POST"
                                    ...
                                    <div class="mb-3">
                                        <label for="provinsi_asal_sekolah" class="form-label">Provinsi Asal
                                            Sekolah</label>
                                        <select name="provinsi_asal_sekolah" class="form-select"
                                            id="provinsi_asal_sekolah" required>
                                    ...
                                    <div class="mb-3">
                                        <label for="alamat_lengkap_sekolah" class="form-label">Alamat Lengkap
                                            Sekolah</label>
                                        <textarea name="alamat_lengkap_sekolah" class="form-control"
                                            id="alamat_lengkap_sekolah" cols="30" rows="10" required></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="status_kelulusan" id="status_kelulusan"
                                            required>
                                    ...
                                    <hr>
                                    <div class="mb-3">
                                        <label for="data_nilai" class="form-label">Data Nilai Raport smt 3 <span
                                                class="text-danger">(wajib diisi apabila nilai ijazah belum ada, jika
                                                sudah ada isikan angka 0 atau -)</span></label>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="bhs_indonesia_smt3"
                                                    name="bhs_indonesia_smt3" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="bhs_inggris_smt3" class="form-label">Bhs Inggris</label>
                                                <input type="text" class="form-control" id="bhs_inggris_smt3"
                                                    name="bhs_inggris_smt3" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="matematika_smt3" class="form-label">Matematika</label>
                                                <input type="text" class="form-control" id="matematika_smt3"
                                                    name="matematika_smt3" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="data_nilai" class="form-label">Data Nilai Raport smt 4 <span
                                                class="text-danger">(wajib diisi apabila nilai ijazah belum ada, jika
                                                sudah ada isikan angka 0 atau -)</span></label>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="bhs_indonesia_smt4"
                                                    name="bhs_indonesia_smt4" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="bhs_inggris_smt4" class="form-label">Bhs Inggris</label>
                                                <input type="text" class="form-control" id="bhs_inggris_smt4"
                                                    name="bhs_inggris_smt4" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="matematika_smt4" class="form-label">Matematika</label>
                                                <input type="text" class="form-control" id="matematika_smt4"
                                                    name="matematika_smt4" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="data_nilai" class="form-label">Data Nilai Raport smt 5 <span
                                                class="text-danger">(wajib diisi apabila nilai ijazah belum ada, jika
                                                sudah ada isikan angka 0 atau -)</span></label>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control" id="bhs_indonesia_smt5"
                                                    name="bhs_indonesia_smt5" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="bhs_inggris_smt5" class="form-label">Bhs Inggris</label>
                                                <input type="text" class="form-control" id="bhs_inggris_smt5"
                                                    name="bhs_inggris_smt5" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="matematika_smt5" class="form-label">Matematika</label>
                                                <input type="text" class="form-control" id="matematika_smt5"
                                                    name="matematika_smt5" required>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="mb-3">
                                        <label for="data_nilai" class="form-label">Data Nilai Ujian Akhir
                                            Nasional/EBTANAS <span class="text-danger">(apabila nilai ijazah belum ada
                                                bisa di isi angka 0 atau -)</span></label>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label for="bhs_indonesia" class="form-label">Bhs Indonesia</label>
                                                <input type="text" class="form-control" id="bhs_indonesia"
                                                    name="bhs_indonesia" required>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="bhs_inggris" class="form-label">Bhs Inggris</label>
                                                <input type="text" class="form-control" id="bhs_inggris"
                                                    name="bhs_inggris" required>
                                            </div>
                                            <div class="col-lg-4">
                            ...
                            <div class="" id="data_prestasi">
                                ...
                                <div class="visually-hidden" id="data_prestasi">
                                    ...
                                    <div class="alert alert-success" role="alert">
                                        ...
                                        <p>Silahkan isi data prestasi yang anda miliki, klik <b>Submit</b> jika ingin
                                            menyimpannya. jika tidak ada atau ingin melanjutkan ke tahap selanjutnya
                                            silakhan klik
                                            <b>Selesai</b>.
                                        </p>
                                        <hr>
                                    </div>
                                    <form action="<?= base_url('user/aksi_tambah_prestasi'); ?>" method="POST"
                                        enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="jenis_kegiatan_lomba" class="form-label">Jenis Kegiatan
                                                Lomba</label>
                                            <input type="text" class="form-control" id="jenis_kegiatan_lomba"
                                                name="jenis_kegiatan_lomba" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="prestasi_juara_ke"
                                                name="prestasi_juara_ke" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="bukti" class="form-label">Bukti/Sertifikat</label>
                                            <input class="form-control" type="file" id="bukti" name="bukti" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                        <a href="<?= base_url('user/prestasi_selesai') ?>"
                                            onclick="javascript: return confirm('Dengan ini data yang saya isikan adalah benar. ')"
                                        ...
                                        <form action="<?= base_url('user/aksi_tambah_data_ortu') ?>" method="POST"
                                            ...
                                            <div class="mb-3">
                                                <label for="pendidikan_terakhir_ayah" class="form-label">Pendidikan
                                                    Terakhir Ayah</label>
                                                <select class="form-select" name="pendidikan_terakhir_ayah"
                                                    id="pendidikan_terakhir_ayah" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="penghasilan_ayah"
                                                    ...
                                                    <option value="Kurang dari Rp.500.000">Kurang dari Rp.500.000
                                                    </option>
                                                    <option value="Rp.1.000.000-Rp.1999.999">Rp.1.000.000-Rp.1999.999
                                                    </option>
                                                    <option value="Rp.2.000.000-Rp.4999.999">Rp.2.000.000-Rp.4999.999
                                                    </option>
                                                    <option value="Rp.5.000.000-Rp.20.000.000">
                                                        Rp.5.000.000-Rp.20.000.000</option>
                                                    <option value="Lebih dari Rp.20.000.000">Lebih dari Rp.20.000.000
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="pendidikan_ibu" class="form-label">Pendidikan Terakhir
                                                    Ibu</label>
                                            ...
                                            <div class="mb-3">
                                                <label for="alamat_lengkap_ortu" class="form-label">Alamat Lengkap Orang
                                                    Tua</label>
                                                <textarea name="alamat_lengkap_ortu" class="form-control"
                                                    id="alamat_lengkap_ortu" cols="30" rows="10" required></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="provinsi_asal_orang_tua" class="form-label">Provinsi Asal
                                                    Orang Tua</label>
                                                <select name="provinsi_asal_orang_tua" class="form-control"
                                                    id="provinsi_asal_orang_tua" required>
                                                    <option value="" selected disabled>Pilih Provinsi Asal Orang Tua
                                                    </option>
                                                    <?php foreach ($provinsi as $prov) : ?>
                                                    <option value="<?= $prov['id']; ?>"><?= $prov['nama_provinsi']; ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label for="kabupaten_asal_orang_tua" class="form-label">Kabupaten Asal
                                                    Orang Tua</label>
                                                <select name="kabupaten_asal_orang_tua" class="form-control"
                                                    id="kabupaten_asal_orang_tua" required>
                                                    <option value="" selected disabled>Pilih Kabupaten Asal Orang Tua
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label for="kodepos_alamat_orang_tua" class="form-label">Kodepos Alamat
                                                    Orang Tua</label>
                                                <input type="text" class="form-control" id="kodepos_alamat_orang_tua"
                                                    name="kodepos_alamat_orang_tua" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="no_telp_orang_tua" class="form-label">No Telp Orang
                                                    Tua</label>
                                                <input type="text" class="form-control" id="no_telp_orang_tua"
                                                    name="no_telp_orang_tua" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="alamat_lengkap_wali" class="form-label">Alamat Lengkap
                                                    Wali</label>
                                                <textarea name="alamat_lengkap_wali" class="form-control"
                                                    id="alamat_lengkap_wali" cols="30" rows="10"></textarea>
                                            </div>
                                            <button type="submit"
                                                onclick="javascript: return confirm('Dengan ini data yang saya isikan adalah benar.')"
                                                class="btn btn-primary">Submit</button>
