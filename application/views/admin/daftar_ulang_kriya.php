                            ...
                            <?php foreach ($ukt as $u) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn badge bg-danger" onclick="javascript: return confirm('Anda yakin akan menghapus ini? ')" href="<?= base_url('admin/hapus_daftar_ulang/' . $u['id'] . '/' . str_replace(' ', '', $title) . '/' . $u['id_user']) ?>">Hapus</a>
                                        <?php if ($u['status_daftar_ulang'] == NULL || $u['status_daftar_ulang'] == 0) : ?>
                                            <a class="btn badge bg-primary" href="<?= base_url('admin/konfirmasi_daftar_ulang/' . $u['id'] . '/' . str_replace(' ', '', $title)) ?>">Konfirmasi</a>
                                        <?php else : ?>
                                            <a class="btn badge bg-danger" href="<?= base_url('admin/batal_konfirmasi_daftar_ulang/' . $u['id'] . '/' . str_replace(' ', '', $title)) ?>">batalkan</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php $i++;
