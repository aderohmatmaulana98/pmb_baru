        ...
        <div class="container">
            <div class="card p-5" id="biodata">
                <form action="<?= base_url('admin/edit_data_biodata') ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3" hidden>
                        ...
                        <input type="text" class="form-control" id="id" name="id" value="<?= $detail_form['id']; ?>"
                            readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap"
                            value="<?= $detail_form['nama_lengkap']; ?>" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                                    value="<?= $detail_form['tempat_lahir']; ?>" required>
                            </div>
                            <div class="col-lg-6">
                                <input type="date" class="form-control" id="tgl_lahir"
                                    value="<?= $detail_form['tanggal_lahir']; ?>" name="tgl_lahir" required>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nik" name="nik" value="<?= $detail_form['nik']; ?>"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kode_pos" name="kode_pos"
                            value="<?= $detail_form['kode_pos'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="kewarganegaraan" class="form-label">Kewarganegaraan</label>
                        <input type="text" class="form-control" id="kewarganegaraan"
                            value="<?= $detail_form['kewarganegaraan'] ?>" name="kewarganegaraan" required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="card visually-hidden p-5" id="data_sekolah">
                <form action="<?= base_url('admin/edit_data_sekolah'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3" hidden>
                        <label for="id" class="form-label">ID</label>
                        <input type="text" class="form-control" id="id" name="id" value="<?= $detail_sekolah['id']; ?>"
                            readonly required>
                    </div>
                    <div class="mb-3" hidden>
                        <label for="nik" class="form-label">NIK</label>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_lengkap_sekolah" class="form-control" id="alamat_lengkap_sekolah"
                            cols="30" rows="10" required><?= $detail_sekolah['alamat_lengkap_sekolah']; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Jurusan</label>
                        <input type="text" class="form-control" id="jurusan" name="jurusan"
                            value="<?= $detail_sekolah['jurusan']; ?>" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_indonesia_smt3"
                                    name="bhs_indonesia_smt3" value="<?= $detail_sekolah['bhs_indo_smt3']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_inggris_smt3" name="bhs_inggris_smt3"
                                    value="<?= $detail_sekolah['bhs_inggris_smt3']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="matematika_smt3" name="matematika_smt3"
                                    value="<?= $detail_sekolah['matematika_smt3']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_indonesia_smt4"
                                    name="bhs_indonesia_smt4" value="<?= $detail_sekolah['bhs_indo_smt4']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_inggris_smt4" name="bhs_inggris_smt4"
                                    value="<?= $detail_sekolah['bhs_inggris_smt4']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="matematika_smt4" name="matematika_smt4"
                                    value="<?= $detail_sekolah['matematika_smt4']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_indonesia_smt5"
                                    name="bhs_indonesia_smt5" value="<?= $detail_sekolah['bhs_indo_smt5']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_inggris_smt5" name="bhs_inggris_smt5"
                                    value="<?= $detail_sekolah['bhs_inggris_smt5']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="matematika_smt5" name="matematika_smt5"
                                    value="<?= $detail_sekolah['matematika_smt5']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control" id="bhs_indonesia" name="bhs_indonesia"
                                    value="<?= $detail_sekolah['bhs_indonesia']; ?>" required>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-success"><a href="" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal<?= $dp['id'] ?>"><i class="text-white"
                                            data-feather="edit"></i></a></span>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?= base_url('admin/edit_data_prestasi') ?>" method="POST"
                                                    enctype="multipart/form-data">
                                                    <div class="mb-3" hidden>
                                                        <label for="id" class="form-label">id</label>
                                                        <input type="text" class="form-control" id="id" name="id"
                                                            value="<?= $dp['id']; ?>" required>
                                                    </div>
                                                    <div class="mb-3" hidden>
                                                        <label for="id" class="form-label">nik</label>
                                                        <input type="text" class="form-control" id="nik" name="nik"
                                                            value="<?= $dp['nik']; ?>" required>
                                                    </div>
                                                    <div class="mb-3" hidden>
                                                        <label for="id" class="form-label">ID User</label>
                                                        <input type="text" class="form-control" id="id_user"
                                                            name="id_user" value="<?= $dp['id_user']; ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="jenis_kegiatan_lomba" class="form-label">Jenis
                                                            Kegiatan Lomba</label>
                                                        <input type="text" class="form-control"
                                                            id="jenis_kegiatan_lomba" name="jenis_kegiatan_lomba"
                                                            value="<?= $dp['jenis_kegiatan_lomba']; ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tingkat_kejuaraan" class="form-label">Tingkat
                                                            Kejuaraan</label>
                                                        <select class="form-select" id="tingkat_kejuaraan"
                                                            name="tingkat_kejuaraan">
                                                            <option disabled selected>Pilih Tingkat Kejuaraan</option>
                                                            <option
                                                                <?= ('Internasional' == $dp['tingkat_kejuaraan']) ? 'selected' : '' ?>
                                                                value="Internasional">Internasional</option>
                                                            <option
                                                                <?= ('Nasional' == $dp['tingkat_kejuaraan']) ? 'selected' : '' ?>
                                                                value="Nasional">Nasional</option>
                                                            <option
                                                                <?= ('Provinsi' == $dp['tingkat_kejuaraan']) ? 'selected' : '' ?>
                                                                value="Provinsi">Provinsi</option>
                                                            <option
                                                                <?= ('Kabupaten/Kota' == $dp['tingkat_kejuaraan']) ? 'selected' : '' ?>
                                                                value="Kabupaten/Kota">Kabupaten/Kota</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="prestasi_juara_ke" class="form-label">Prestasi Juara
                                                            Ke</label>
                                                        <input type="text" class="form-control" id="prestasi_juara_ke"
                                                            name="prestasi_juara_ke"
                                                            value="<?= $dp['prestasi_juara_ke']; ?>" required>
                                                    </div>
                                            </div>
                                ...
                                <span class="badge bg-danger"><a
                                        ...
                                        href="<?= base_url('admin/hapus_prestasi/') . $dp['nik'] . '/' . $dp['id_user'] . '/' . $dp['id'] ?>"><i
                                            class="text-white" data-feather="trash"></i></a></span>
                            </td>
                        </tr>
                        <?php $i++;
                        endforeach; ?>
            ...
            <div class="card p-5 visually-hidden" id="data_ortu">
                <form action="<?= base_url('admin/edit_data_ortu') ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3" hidden>
                        <label for="id" class="form-label">ID</label>
                        <input type="text" class="form-control" id="id" name="id" value="<?= $data_ortu['id']; ?>"
                            readonly required>
                    </div>
                    <div class="mb-3" hidden>
                        <label for="nik" class="form-label">nik</label>
                        <input type="text" class="form-control" id="nik" name="nik" value="<?= $data_ortu['nik']; ?>"
                            readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="nama_ayah" class="form-label">Nama Ayah</label>
                        <input type="text" class="form-control" id="nama_ayah" name="nama_ayah"
                            value="<?= $data_ortu['nama_ayah']; ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah"
                            value="<?= $data_ortu['pekerjaan_ayah']; ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_lengkap_ortu" class="form-control" id="alamat_lengkap_ortu" cols="30"
                            rows="10" required><?= $data_ortu['alamat_lengkap_ortu']; ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kodepos_alamat_orang_tua"
                            name="kodepos_alamat_orang_tua" value="<?= $data_ortu['kode_pos_ortu'] ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_lengkap_wali" class="form-control" id="alamat_lengkap_wali" cols="30"
                            rows="10"><?= $data_ortu['alamat_lengkap_wali'] ?></textarea>
                    </div>
                    <button class="btn btn-primary" type="submit">Simpan</button>
                </form>
            ...
            <div class="card p-3">
                <div class="row text-center">
                    ...
                    <span class="col-lg-4">
                        <a href="<?= base_url('admin/finalisasi/') . $detail_form['nik'] . '/' . $detail_form['id_user'] . '/' . $detail_form['id']; ?>"
                            class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Finalisasi Sekarang"><i data-feather="check"></i> Finalisasi Data</a>
                    </span>
                    <?php else : ?>
                    <span class="col-lg-4">
                        <a href="<?= base_url('admin/batal_finalisasi/') . $detail_form['nik'] . '/' . $detail_form['id_user'] . '/' . $detail_form['id']; ?>"
                            class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Batalkan Finalisasi"><i data-feather="x-square"></i> Batalkan Finalisasi Data</a>
                    </span>
                    <?php endif; ?>
                    <?php if ($detail_form['status_validasi_berkas'] == 0) : ?>
                    <span class="col-lg-4">
                        <a href="<?= base_url('admin/status_validasi_berkas/') . $detail_form['nik'] . '/' . $detail_form['id_user'] . '/' . $detail_form['id']; ?>"
                            class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Validasi Sekarang"><i data-feather="check"></i> Validasi Berkas Data</a>
                    </span>
                    <?php else : ?>
                    <span class="col-lg-4">
                        <a href="<?= base_url('admin/batal_status_validasi_berkas/') . $detail_form['nik'] . '/' . $detail_form['id_user'] . '/' . $detail_form['id']; ?>"
                            class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Batalkan Validasi"><i data-feather="x-square"></i>Batalkan Validasi Berkas Data</a>
                    </span>
                    <?php endif; ?>
                    <span class="col-lg-4">
                        <a href="<?= base_url('admin/data_sudah_finalisasi'); ?>" class="btn btn-primary"><i
