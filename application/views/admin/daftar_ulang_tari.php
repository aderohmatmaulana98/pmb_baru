                    ...
                    <table class="table table-hover" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $u['jenis_ukt']; ?></td>
                                <td>
                                    <a class="badge bg-primary mb-2"
                                        href="<?= base_url('admin/detail_ukt/' . $u['id']) ?>">Lihat</a>
                                    <a class="badge bg-warning mb-2" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal<?= $u['id']; ?>" href="#">Edit UKT</a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= base_url('admin/edit_ukt') ?>" method="post">
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">Uang
                                    ...
                                    <a class="btn badge bg-danger"
                                        ...
                                        href="<?= base_url('admin/hapus_daftar_ulang/' . $u['id'] . '/' . str_replace(' ', '', $title) . '/' . $u['id_user']) ?>">Hapus</a>
                                    <?php if ($u['status_daftar_ulang'] == NULL || $u['status_daftar_ulang'] == 0) : ?>
                                    <a class="btn badge bg-primary"
                                        href="<?= base_url('admin/konfirmasi_daftar_ulang/' . $u['id'] . '/' . str_replace(' ', '', $title)) ?>">Konfirmasi</a>
                                    <?php else : ?>
                                    <a class="btn badge bg-danger"
                                        href="<?= base_url('admin/batal_konfirmasi_daftar_ulang/' . $u['id'] . '/' . str_replace(' ', '', $title)) ?>">batalkan</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php $i++;
