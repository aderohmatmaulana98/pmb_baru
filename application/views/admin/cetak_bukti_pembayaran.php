...
<body>
    <div class="container-sm">
        ...
        <table class="table table-bordered mt-3" style="width: 100%;">
            <tr class="text-left">
                <th scope="col" style="width: 20%;">No Virtual Account</th>
                <td scope="col" width="1%">:</td>
                <td scope="col" style="width: 20%;"><?= $pembayaran['no_pembayaran']; ?></td>
            </tr>
            <tr class="text-left">
            ...
            <tr class="text-left">
                <th scope="col" style="width: 20%;">Tahun_ajaran</th>
                <td scope="col" width="1%">:</td>
                <td scope="col" style="width: 20%;"><?= $pembayaran['tahun_ajaran']; ?></td>
            </tr>
            <tr class="text-left">
                <th scope="col" style="width: 20%;">Jalur</th>
                <td scope="col" width="1%">:</td>
                <td scope="col" style="width: 20%;"><?= $pembayaran['jalur_pendaftaran'] ?></td>
            </tr>
            <tr class="text-left">
                <th scope="col" style="width: 20%;">Total Bayar</th>
                <td scope="col" width="1%">:</td>
                <?php if ($pembayaran['jalur_pendaftaran'] == 'Reguler') : ?>
                <td scope="col" style="width: 20%;">Rp.200.000,00</td>
                <?php else : ?>
