                                ...
                                <div class="row ml-2">
                                    <div class="col-lg-12 row">
                                        <ol>
                                            ...
                                            <li>Calon Mahasiswa melakukan pembayaran sebesar Rp. 200.000,00 datang langsung ke loket pendaftaran di kampus Akademi Komunitas Negeri Seni dan Budaya Yogyakarta.</li>
                    ...
                    <div class="col-lg-10 order-12 order-lg-1">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="card shadow-lg col-lg-10 px-5 py-3">
                                ...
                                <div class="row ml-2">
                                    <div class="col-lg-12 row">
                                        <p>Selamat Kepada calon mahasiswa bagi yang lolos seleksi gelombang II nama-nama nya terlampir pada file berikut.
Bagi yang belum lolos jangan putus asa dan tetap semangat serta tingkatkan kompetensi.
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 order-12 order-lg-1">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="card shadow col-lg-6">
                                <div class="card-body">
                                    <h6>REGISTRASI MAHASISWA BARU AKADEMI KOMUNITAS NEGERI SENI DAN BUDAYA YOGYAKARTA TAHUN AKADEMIK 2022-2023 :</h6>
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <ol type="a">
                                                <li>
                                                    FC Ijazah dan SKHUN yang telah dilegalisir sebanyak @1 lembar.(Bagi yang belum menyerahkan)
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    Surat Keterangan Sehat Jasmani dari dokter. (Bagi yang belum menyerahkan).
                                                </li>
                                                <li>
                                                    Surat Keterangan Bebas Napza. (Bagi yang belum menyerahkan).
                                                </li>
                                                <li>
                                                     Materai Rp. 10.000,- sebanyak 1 lembar. (Bagi yang belum menandatangani surat pernyataan mahasiswa).
                                                </li>
                                            </ol>
                                        </li>
                                        <li>
