...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2022 at 04:28 AM
...
(7, 'Ruhiyat', 'SMP', 'Buruh', 'Rp.1.000.000-Rp.1999.999', 'ENO TURSINI', 'SMA', 'Buruh', 'Rp.1.000.000-Rp.1999.999', 'Jl. Kebun Agung Rt. 02 Rw. 34, Dsn, Bedingin, Sumberadi, Kec. Mlati', 61, 6106, '55288', '089765342534', '', '', '', 29);
...
INSERT INTO `detail_sekolah` (`id`, `nama_sekolah`, `jenis_sekolah`, `alamat_lengkap_sekolah`, `jurusan`, `status_kelulusan`, `tahun_lulus`, `no_ijazah`, `tgl_ijazah`, `bhs_indonesia`, `bhs_inggris`, `matematika`, `id_user_calon_mhs`, `id_provinsi`) VALUES
(7, 'SMK TAMAN SISWA', 'Swasta', 'Jl. Jaksa Agung Raya Suprapto No.33, Gawanan, Sukoharjo, Kec. Sukoharjo, Kabupaten Sukoharjo, Jawa Tengah 57512', 'IPS', 0, 2021, '3243424', '2022-04-07', 87, 89, 84, 29, 32);
...
(1, 'Gelombang 1', '2022-04-02', '2022-04-28', '2022-04-30 10:00:00', 1),
(2, 'Gelombang 2', '2022-05-30', '2022-05-28', '2022-05-30 09:00:00', 1);
...
--
-- Table structure for table `kabupaten_diy`
--
...
--
-- Dumping data for table `kabupaten_diy`
--
...
(36, 'PMB-613', 'Ade Rohmat Maulana', 'AKNSBY (Kemitraan Pemprov DIY)', 'Majalengka', '2022-04-04', 1, 'Islam', 'Jl. Kebun Agung Rt. 02 Rw. 34, Dsn, Bedingin, Sumberadi, Kec. Mlati', '089612664229', 'JAWA BARAT', 'Belum Menikah', '55288', 'Indonesia', '517041133023.jpg', 1, 34, 3404, 3404060, NULL, 29, '2022-04-28', 1, 2, 1, 1);
...
--
-- Table structure for table `surat_pernyataan`
--
...
--
-- Dumping data for table `surat_pernyataan`
--
...
INSERT INTO `user` (`id`, `nama_lengkap`, `nik`, `no_whatsapp`, `email`, `password`, `date_created`, `image`, `is_active`, `role_id`, `cek_isi`, `isi_biodata`, `isi_sekolah_asal`, `isi_prestasi`, `isi_data_ortu`, `no_slip`, `bukti_bayar`, `status_bayar`, `id_th_ajaran`) VALUES
(10, 'Tasya', '321765663546', NULL, 'tasya@gmail.com', '$2y$10$kSEac0c8YlutCVD3mfMbcOyddCXR0gHLCIO/MzAv/updMU1U506B6', 1645517931, 'default.png', 1, 3, NULL, 0, 0, 0, 0, '', '', 0, 0),
(13, 'Tasya Puspa Nabilla', '1234567898765432', '089612664228', 'tasyapuspa8@gmail.com', '$2y$10$ojzIuucY5Pd89qzXvHy0ZOPMZqIdlWSrtMxboXEBBCqh5AhI3f21.', 1646188958, 'default.png', 1, 2, NULL, 0, 0, 0, 0, '', '', 0, 0),
(29, 'Ade Rohmat Maulana', '3401015907660001', '089612664228', 'aderohmatmaulana22@gmail.com', '$2y$10$Qb8gTCfVDjvngPgq3uNE8.afvOzl5ASs6eD9fL5dr5FNdNmhTxtLm', 1651110766, 'default.png', 1, 4, 1, 1, 1, 1, 1, '54646546', 'b1.jpeg', 1, 2);
...
(14, 1, 'Terbitkan Pengumuman', 'admin/pengumuman', 'bell', 1),
...
(18, 1, 'Verifikasi Bayar', 'admin/verifikasi_bayar', 'credit-card', 1),
(19, 1, 'Pembayaran', 'admin/pembayaran', 'dollar-sign', 1);
...
--
-- Indexes for table `kabupaten_diy`
--
...
--
-- Indexes for table `surat_pernyataan`
--
...
--
-- AUTO_INCREMENT for table `kabupaten_diy`
--
ALTER TABLE `kabupaten_diy`
...
--
-- AUTO_INCREMENT for table `surat_pernyataan`
--
ALTER TABLE `surat_pernyataan`
